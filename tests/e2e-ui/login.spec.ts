...
test.describe('Login', () => {
    ...
    test('standart user is able to login with valid creds and logout', { tag: '@e2e' }, async ({ page }) => {
    ...
    test('locked user is not able to login and error message is displayed on Login page',  { tag: '@e2e' }, async ({ page }) => {
    ...
    test('it is not allowed to login with invalid creds', { tag: '@e2e' }, async ({ page }) => {
    ...
    test('it is not allowed to login with empty fields', { tag: '@e2e' }, async ({ page }) => {
